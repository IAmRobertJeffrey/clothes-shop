...
const Product = ({ current, handleAddProduct }) =>
{
	...
	return (
		<Box display="flex"
			...
			<Box justifyContent="space-between" display="flex" p="5">&#163;{current.product_price} <Button onClick={() => handleAddProduct(current.product.id)} colorScheme="teal">Add To Basket</Button></Box>
